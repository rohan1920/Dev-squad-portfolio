...
export default function CodeSamplesSection() {
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-xl font-semibold text-black">GitHub Repository</h3>
          </div>
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <h3 className="text-xl font-semibold text-black">Architecture & Flow</h3>
          </div>
          <p className="text-gray-700 mb-6">
      ...
      <HoverAnimate
        variant="card"
        className="mt-8 card bg-white text-black border-black/10"
      >
        <div className="flex items-center gap-4 mb-4">
          ...
          <h3 className="text-xl font-semibold text-black">Team Contributions</h3>
        </div>
